...
namespace TarodevController {
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        private void Update()
        {
            ...
            else //Boris I need you to help me make this work but for left instead of right. Ive already set a bool to make it a separate thing, we just need to figure out what we need to change for the direction.///
            {
                if(Input.Dash)
                {
                    transform.position = Vector3.Lerp(transform.position, myPositions[posIndex], lerpTime * Time.deltaTime);
        ...
        private void GatherInput()
        {
            Input = new FrameInput
            {
                ...
                Dash = UnityEngine.Input.GetMouseButtonDown(1),
            };
            if (Input.JumpDown)
            {
